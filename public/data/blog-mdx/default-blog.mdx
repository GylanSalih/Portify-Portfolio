...
<CustomImage 
src="/assets/images/portfolio/GITS2.jpg" 
alt="Ghost in the Shell Project 2" 
caption="Ghost in the Shell - Character Model" 
width={400} 
height={300} 
/>
...
This is a [link to another section](#introduction) within the same page. You can also create [external links](https://example.com){:target="_blank" rel="noopener noreferrer"} that open in new tabs.

### External Links

[Live Demo](https://example.com/demo){:target="_blank" rel="noopener noreferrer"}
...
<Note>This is a note callout for general information and tips.</Note>

<Warning>This is a warning callout for important notices and potential issues.</Warning>

<Success>This is a success callout for positive feedback and achievements.</Success>

<Error>This is an error callout for critical issues and problems.</Error>

<Tip>This is a tip callout for helpful suggestions and best practices.</Tip>

<Caution>This is a caution callout for careful attention and considerations.</Caution>

<Important>This is an important callout for essential information that requires attention.</Important>
...
<Note>This note contains important information about the project.</Note>

Here's a code snippet: `const example = 'Hello World';`

<Warning>Remember to optimize images for web performance!</Warning>
...
* **Media:** Custom images with captions and video components
* **Interactive:** Details/summary elements and footnotes
* **Callouts:** All admonition types (Note, Warning, Success, Error, Tip, Caution, Important)
